...
var availableActions = { 
    'StartPoint': { 
        'Label': 'Start Point', 'Type': 'Start', 'SizeY': 1, 'SizeX': 1, 'AvailableAmount': 1 }, 
    'EndPoint': { 
        'Label': 'End Point', 'Type': 'End', 'SizeY': 1, 'SizeX': 1, 'AvailableAmount': 1 },
    'Obstacle1': { 
        'Label': 'Small Obstacle', 'Type':'Obstacle', 'SizeY': 1, 'SizeX': 1, 'AvailableAmount': 50 },
    'Obstacle2': { 
        'Label': 'Medium Obstacle', 'Type':'Obstacle', 'SizeY': 3, 'SizeX': 2, 'AvailableAmount': 10 },
    'Hindrance1': { 
            'Label': 'Small Hindrance', 'Type':'Hindrance', 'SizeY': 1, 'SizeX': 1, 'AvailableAmount': 10 }};
var actionButtons = [];
